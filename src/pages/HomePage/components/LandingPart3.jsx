        ...
        <Box className="flex-box-normal">
          ...
          <Stack flex={3} spacing={4} alignItems="flex-start">
            ...
            <Typography variant="body3_r" color="neutral.grey">
              ...
              fringilla. Pellentesque placerat vestibulum lorem sed porta. Nullam mattis tristique iaculis. Nullam pulvinar sit amet risus
              pretium auctor. Etiam quis massa pulvinar, aliquam quam vitae, tempus sem. Donec elementum pulvinar odio.
            </Typography>
